...
- Removed overrides for React types in pnpm workspace configuration by [@kayp514](https://github.com/kayp514)

### Patch Changes

- fix: updated react ([#55](https://github.com/TernSecure/auth/pull/55)) by [@kayp514](https://github.com/kayp514)

- feat: integrate OTP input component and enhance phone verification flow ([#75](https://github.com/TernSecure/auth/pull/75)) by [@kayp514](https://github.com/kayp514)
...
- feat: add 'tern' prefix to button styles and update components configuration ([#67](https://github.com/TernSecure/auth/pull/67)) by [@kayp514](https://github.com/kayp514)
...
- refactor: simplify body styles by removing redundant background application ([#70](https://github.com/TernSecure/auth/pull/70)) by [@kayp514](https://github.com/kayp514)
...
- feat: implement CSS isolation for .tern-secure-auth and update postcss configuration ([#63](https://github.com/TernSecure/auth/pull/63)) by [@kayp514](https://github.com/kayp514)

- refactor: remove unnecessary wrapper div from SignInRoutes component ([#62](https://github.com/TernSecure/auth/pull/62)) by [@kayp514](https://github.com/kayp514)

- feat: add 'tern' prefix to styles and components for consistent theming ([#69](https://github.com/TernSecure/auth/pull/69)) by [@kayp514](https://github.com/kayp514)

- feat: enhance social login support by adding multiple providers and updating related components ([#71](https://github.com/TernSecure/auth/pull/71)) by [@kayp514](https://github.com/kayp514)
...
- feat: implement redirect result handling in SignIn class and add effect in SignInSocialButtons component ([#73](https://github.com/TernSecure/auth/pull/73)) by [@kayp514](https://github.com/kayp514)
...
- fix: update verification URL handling in SignIn class and comment out requiresVerification in RootLayout ([#60](https://github.com/TernSecure/auth/pull/60)) by [@kayp514](https://github.com/kayp514)
...
- feat: enhance dark mode support in postcss config and add isolation to body in index.css ([#61](https://github.com/TernSecure/auth/pull/61)) by [@kayp514](https://github.com/kayp514)
...
- refactor: update redirect result handling to use status property in SignIn context ([#74](https://github.com/TernSecure/auth/pull/74)) by [@kayp514](https://github.com/kayp514)

- feat: appcheck uses REST API ([#54](https://github.com/TernSecure/auth/pull/54)) by [@kayp514](https://github.com/kayp514)

- refactor: update components and styles for improved responsiveness and consistency ([#68](https://github.com/TernSecure/auth/pull/68)) by [@kayp514](https://github.com/kayp514)
...
- feat: update class names for consistent prefixing and enhance postcss configuration ([#65](https://github.com/TernSecure/auth/pull/65)) by [@kayp514](https://github.com/kayp514)
...
- refactor: simplify postcss configuration and remove CSS isolation for .tern-secure-auth ([#64](https://github.com/TernSecure/auth/pull/64)) by [@kayp514](https://github.com/kayp514)

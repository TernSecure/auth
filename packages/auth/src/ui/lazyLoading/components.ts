...
const componentImportPaths = {
    SignIn: () => import(/* webpackChunkName: "signin" */ '../components/sign-in'),
    SignUp: () => import(/* webpackChunkName: "signup" */ '../components/sign-up'),
    UserButton: () => import(/* webpackChunkName: "userbutton" */ '../components/user-button'),
} as const;
